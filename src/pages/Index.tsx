...
const primaryCtaLabel = "無料診断を60秒で開始する";
const heroSnapshotHighlights = [
  {
    label: "90日で平均ROAS+32%",
    description: "RevOps改善ログを活かし、広告費の投資効率を底上げします。",
  },
  {
    label: "指名検索+38%を再現",
    description: "比較診断レポートが指名流入を増やし、商談化率を押し上げます。",
  },
  {
    label: "回収中央値4.5か月",
    description: "初期費用0円・月額48万円＋成果連動12%で投資回収を最短化。",
  },
];
const heroTrustSignals = [
  {
    label: "導入128社・継続率87%",
    description: "製造B2B特化の伴走体制で平均継続期間14.6か月を維持。",
  },
  {
    label: "経済産業省 認定経営革新等支援機関",
    description: "金融機関基準で計画と想定問答を監修し、審査を円滑化。",
  },
  {
    label: "NPS47・口コミ4.6/5.0",
    description: "意思決定スピードとROI再現性が評価され高い推奨度を獲得。",
  },
];
...
const heroResults: HeroResult[] = [
  {
    value: "+32%",
    label: "平均ROAS改善幅",
    description: "90日間の伴走で広告投資効率を+32%押し上げ。",
    source: "導入128社平均 (2024)",
  },
  {
    value: "4.5ヶ月",
    label: "投資回収中央値",
    description: "初期費用0円で回収期間中央値は4.5か月。",
    source: "支援プロジェクト実績 (n=36)",
  },
  {
    value: "87%",
    label: "継続率",
    description: "成果創出まで伴走した案件の継続率87%。",
...
const heroPainPoints = [
  {
    title: "改善会議まで平均21日",
    detail: "部門ごとに数値が分断され、意思決定が月2回先送りになっている。",
  },
  {
    title: "広告投資が赤字循環",
    detail: "ROASが18%ずつ失速し、広告費月480万円が粗利を圧迫している。",
  },
  {
    title: "指名検索が横ばい",
    detail: "月90件で頭打ちとなり、稟議で示す成長ストーリーが弱い。",
  },
];
...
const heroSummaryCards: HeroSummaryCard[] = [
  {
    title: "3分で成果ストーリー",
    description:
      "72時間診断→1〜2週間計画→90日伴走の成果と、ROAS・指名検索の改善幅を一目で整理。",
    stat: "CVR中央値+26%",
    icon: BookOpen,
  },
  {
    title: "KPIとROIを数値で把握",
    description:
      "平均ROAS+32%、指名検索+38%、回収期間4.5か月など投資判断指標を可視化。",
    stat: "ROI平均3.4倍",
    icon: BarChart4,
  },
  {
    title: "導入ハードルをチェック",
    description:
      "初期費用0円・月額48万円・入力7項目で着手できる導線と稟議資料の雛形を共有。",
    stat: "準備工数-145h/月",
    icon: PlayCircle,
  },
];
...
const heroMetrics = [
  {
    ...
    note: "導入128社平均",
    detail:
      "RevOpsダッシュボードと週次伴走で広告投資の無駄を削減し、90日で平均+32%のROAS改善を実現。",
    prefix: "+",
    suffix: "%",
    target: 32,
  },
  {
    ...
    note: "検索ログ解析 (n=18)",
    detail:
      "比較診断レポートとブランドガイドの改善で、指名検索が平均38%増加し商談化率2.1倍に。",
    prefix: "+",
    suffix: "%",
    target: 38,
  },
  {
    label: "回収期間中央値",
    note: "契約更新ログ (2023-2024)",
    detail:
      "初期費用0円・月額48万円＋成果連動12%で投資を抑え、中央値4.5か月で費用を回収。",
    prefix: "",
    suffix: "ヶ月",
    target: 4.5,
    decimals: 1,
...
const competitorComparison: ComparisonRow[] = [
  {
    axis: "対応業種",
    ourValue:
      "製造B2B特化で導入128社・成功率78%。現場データと営業プロセスに精通したRevOpsチームが伴走。",
    others: "競合Aは多業種展開で成功率52%。競合BはSaaS偏重で製造業のデータ設計が標準化されていない。",
    proof: "案件DB (2022-2024)",
  },
  {
    axis: "成果速度",
    ourValue:
      "45日でCVR+26%・ROAS+32%を中央値で達成。週次スプリントで仮説→実行→検証を繰り返します。",
    others: "競合Aは90日でCVR+12%、競合Bは75日でCVR+14%。スプリントと再現ログが不足。",
    proof: "改善ログ (n=64)",
  },
  {
    axis: "料金とリスク",
    ourValue:
      "初期0円＋月額48万円＋成果連動12%。成果未達時は月額の50%返金・途中解約は30日前通知で日割精算。",
    others: "競合Aは初期30万円＋月額35万円で返金なし。競合Bは最低契約12ヶ月・解約手数料15万円。",
    proof: "契約条件比較 (2024)",
  },
  {
    axis: "リソース要求",
    ourValue:
      "御社の稼働は週1回30分MTGと数値共有のみ。分析はAIと専門家が担当し、稟議資料まで納品。",
    others: "競合は社内で資料整備やデータ加工が必須で、担当者の稼働が月40時間を超えるケースが多い。",
    proof: "導入企業ワークログ",
  },
];
...
const quickFlowSteps: QuickFlowStep[] = [
  {
    label: "60秒で無料診断に申し込む",
    description: "入力7項目で当日受付",
    detail:
      "メールと会社名、課題感を記入するだけ。毎月先着20社の枠に即時エントリーし、受付完了メールでヒアリング候補日をご案内します。",
    icon: CalendarClock,
    duration: "Day0",
  },
  {
    label: "経営課題診断レポート",
    description: "72時間で優先指標とROIを提示",
    detail:
      "生成AIが財務・広告・在庫データを解析し、ROAS改善仮説30本と回収4.5か月シナリオをレポート化。診断士が稟議用メモを添えます。",
    icon: ScanSearch,
    duration: "Day1-3",
  },
  {
    label: "改善計画と伴走開始",
    description: "1〜2週間で計画完成→90日伴走",
    detail:
      "金融機関提出レベルの計画書・想定問答を1〜2週間で納品。以降90日はRevOpsチームが週次スプリントで実行と資金調達を支援します。",
    icon: ClipboardCheck,
    duration: "Day4-60",
  },
];
...
const quickFormHighlights: QuickFormHighlight[] = [
  {
    title: "入力7項目・60秒で完了",
    caption: "所要時間1分・初期費用0円で優先課題の仮説を提示",
    icon: Shield,
  },
  {
    title: "72時間でROI試算送付",
    caption: "AI分析と診断士レビューでROAS・回収表を共有",
    icon: Timer,
  },
  {
    title: "途中解約も日割精算",
    caption: "返金保証50%・途中離脱時も安心の契約設計",
    icon: LineChart,
  },
];
...
const outcomeNarrative = [
  {
    stage: "注意",
    headline: "改善会議が21日遅れROASが18%失速",
    metric: "機会損失 月480万円",
    description:
      "部署ごとに数値が分断され、判断が月2回先送り。広告費は投資効率を欠き、指名検索も月90件で横ばいでした。",
    evidence: "ヒアリング: 導入企業20社 (2024)",
  },
  {
    stage: "興味",
    headline: "AI診断が72時間で優先指標と仮説30本を生成",
    metric: "改善仮説 30本/週",
    description:
      "財務・広告・在庫データをAIが統合し、ROAS失速の要因と改善案を色分け。診断士が週次レビュー用の論点メモを整備します。",
    evidence: "運用ログ & 改善ノート",
  },
  {
    stage: "確信",
    headline: "45日スプリントでROIと資金調達を同時管理",
    metric: "回収中央値 4.5ヶ月",
    description:
      "調査→設計→実装→検証の4工程を45日で回し、ROI・指名検索・LTVを可視化。金融機関向け想定問答も同時に更新します。",
    evidence: "成果レビュー: Q1-Q4 2024",
  },
  {
    stage: "行動",
    headline: "入力7項目・60秒で無料診断を開始",
    metric: "初期費用 0円",
    description:
      "申し込み直後にヒアリング枠を確保し、72時間以内にROI試算と改善ロードマップを送付。成果未達時は費用50%を返金します。",
    evidence: "申込ログ & 契約条件",
  },
];
...
const painPoints: PainPoint[] = [
  {
    title: "改善判断が21日遅れROASが失速",
    detail:
      "部署別データが噛み合わず、広告費月480万円の投資判断が先送りになっています。",
    summary:
      "判断まで平均21日、ROASは18%ずつ低下。",
    solution:
      "72時間のAI異常検知で優先指標と赤字施策を洗い出し、週次の改善ロードマップで判断を前倒しします。",
    aiAction:
      "AI: 財務・広告・在庫データを統合し、ROAS低下の要因と改善余地を自動で色分け。",
    expertAction:
      "専門家: RevOps経験者が改善仮説30本を優先度順に整理し、会議資料を整備。",
    impact: "ROASと指名検索を回復",
    impactDetail:
      "90日でROAS190%→278%、指名検索90件→152件という再現例を共有します。",
    icon: ScanSearch,
    accent: "sky",
    proofs: [
      { label: "ROAS改善", value: "+32%" },
      { label: "判断時間", value: "-67%" },
    ],
  },
  {
    title: "金融機関資料づくりが稟議を圧迫",
    detail:
      "想定問答とKPI根拠の準備に月40時間を要し、融資や補助金の機会を逃しています。",
    summary:
      "資料整備が遅れ、投資判断が停滞。",
    solution:
      "AIドラフトと診断士レビューで1〜2週間で金融機関提出レベルに仕上げ、稟議を前倒しします。",
    aiAction:
      "AI: 与信指標に沿って収益シナリオと稟議資料テンプレートを生成。",
    expertAction:
      "専門家: 経産省認定チームが表現と根拠を補強し、想定問答と比較表を整備。",
    impact: "回収期間を可視化",
    impactDetail:
      "中央値4.5か月の回収シミュレーションと補助金採択率86%の根拠で社内説得を支援。",
    icon: LineChart,
    accent: "citrus",
    proofs: [
      { label: "回収中央値", value: "4.5ヶ月" },
      { label: "採択率", value: "86%" },
    ],
  },
  {
    title: "AI活用が定着せず成果が証明できない",
    detail:
      "部門ごとに施策が散らばり、週次レビューで改善ログが残らず再現性が担保できません。",
    summary:
      "実行体制が整わずROIが示せない。",
    solution:
      "90日伴走で実行→検証→資金確保を一気通貫で支援し、LTV1.4倍の改善を再現します。",
    aiAction:
      "AI: KPI進捗とリスクアラートを週次で通知し、改善ログと試算を自動保存。",
    expertAction:
      "専門家: RevOpsチームが週次レビューと営業スクリプト刷新を伴走し、施策を定着。",
    impact: "LTVと継続率を向上",
    impactDetail:
      "商談化率16%→27%、LTV1.4倍、継続率87%の実績で意思決定を支援します。",
    icon: Users2,
    accent: "mint",
    proofs: [
      { label: "商談化率", value: "2.1倍" },
      { label: "継続率", value: "87%" },
    ],
  },
];
...
const successStories: SuccessStory[] = [
  {
    ...
    name: "井上 研二",
    title: "代表取締役",
    projectScale: "年商18億円 / 従業員180名",
    quote:
      "会議の判断が毎回遅れ、広告費が赤字循環していました。AI診断と専門家の伴走で優先度が即決でき、ROASと指名検索が一気に戻りました。",
    summary:
      "主要製品の需要変動で広告効率が失速。AIがROAS低下要因と改善仮説30本を提示し、診断士が週次スプリントで実行支援。90日でROAS190%→278%、指名検索90件→152件へ回復しました。",
    challenge: "部署ごとに指標が分断され、改善会議まで平均21日を要していた。",
    aiRole:
      "財務・広告・在庫データを統合し、ROAS低下の要因と改善余地を色分け。",
    expertRole:
      "RevOps専任チームが改善ロードマップと稟議資料を整備し、週次レビューで成果を確認。",
    governance:
      "週次ダッシュボードでKPIと投資配分を共有し、金融機関向け想定問答も同時に更新。",
    metrics: [
      {
        label: "CVR",
        before: "1.8%",
  ...
  },
  {
    ...
    name: "高嶋 明日香",
    title: "営業本部長",
    projectScale: "年商9億円 / 営業36名",
    quote:
      "商談化率が停滞し、リード単価も高止まりしていました。AI診断で優先顧客が明確になり、営業スクリプトの刷新で受注が加速しました。",
    summary:
      "既存顧客依存で新規開拓が伸び悩み。AIがLTV別の優先顧客と提案パターンを算出し、診断士がRevOpsダッシュボードと稟議資料を整備。90日で商談化率16%→27%、リード単価2.4万円→1.6万円、NPS18→45を達成しました。",
    challenge: "営業とマーケで指標が分断され、受注に直結する改善サイクルが回っていなかった。",
    aiRole:
      "CRM・広告・顧客属性を統合し、LTVと商談確度をスコアリング。",
    expertRole:
      "RevOpsチームが営業スクリプトとキャンペーン優先度を設計し、週次レビューを伴走。",
    governance:
      "週次でダッシュボードと商談ログを振り返り、改善タスクとROI指標を共有。",
    metrics: [
      {
        label: "商談化率",
        before: "16%",
...
const faqItems = [
  {
    question: "料金はいくらですか？",
    answer:
      "初期費用0円・月額48万円に成果連動12%を加えたシンプルな体系です。平均ROIは3.4倍、投資回収中央値は4.5か月です。",
  },
  {
    question: "契約期間の目安は？",
    answer:
      "初回は3か月契約で、以降は1か月更新です。契約更新率は87%で、最短3か月でも改善ロードマップの引き継ぎを行います。",
  },
  {
    question: "どこまで伴走してもらえますか？",
    answer:
      "広告改善・LP最適化・CRM分析・営業スクリプト・資金調達資料まで一気通貫で支援。週次レビューと稟議資料更新も担当します。",
  },
  {
    question: "社内で必要な体制は？",
    answer:
      "御社側は週1回30分の定例とKPI共有のみ。データ整備や資料作成はAIと専門家が対応し、入力は7項目・所要60秒で完了します。",
  },
  {
    question: "データ管理と秘密保持は安全ですか？",
    answer:
      "ISO27001準拠の環境でTLS1.3通信・AES256暗号化を実施。NDA締結後にアクセス権を限定し、ログは90日保管します。",
  },
  {
    question: "補助金や助成金は使えますか？",
    answer:
      "IT導入補助金A類型や事業再構築補助金の採択率は86%。要件整理・申請書ドラフト・実績報告まで専門家が伴走します。",
  },
  {
    question: "稟議や取締役会向け資料は用意されますか？",
    answer:
      "ROI試算、比較表、リスク管理をまとめた20ページの稟議パックを3営業日で提供。更新履歴も残し承認プロセスを支援します。",
  },
  {
    question: "導入までのスケジュールは？",
    answer:
      "申し込み当日中に日程調整、72時間でAI診断レポート、1〜2週間で計画ドラフト、45日で初回スプリントの成果レビューを実施します。",
  },
  {
    question: "途中解約や休止はできますか？",
    answer:
      "30日前通知で日割精算し違約金は0円です。プロジェクトを一時休止する場合もデータと進捗はそのまま保全されます。",
  },
  {
    question: "成果保証はありますか？",
    answer:
      "目標ROASやCVRの未達時は月額費用の50%を返金。改善計画を再設計し、テスト施策を追加でご提示します。",
  },
];
        ...
        >
          ...
          <div className="container hero-inner">
            <div className="hero-copy" data-animate data-initial-visible="true">
              <span className="badge">年商5〜50億円の製造B2B経営者向け</span>
              <h1 id="hero-heading">
                製造B2B指標を高速整備
                <span>90日で改善路線化</span>
              </h1>
              <p className="hero-lead">
                あなたのROASを90日で平均32%押し上げ、LTVを1.4倍へ引き上げた再現性ある伴走チームです（導入128社）。
              </p>
        ...
        >
          <div className="container">
            <div className="story-header" data-animate>
              ...
              <p>
                72時間の集中診断で現状を把握し、1〜2週間で金融機関も納得する戦略シナリオをドラフト。以降90日は専門家がAIダッシュボードと共に伴走し、施策実行・補助金申請・資金調達まで支援します。スピード・品質・実行力を同時に実現する共創プロセスが、平均ROAS+32%、CVR+26%、指名検索+38%という成果につながっています。
              </p>
            </div>
        ...
        <section className="section final-cta" aria-labelledby="final-cta-heading">
          <div className="container">
            <div className="final-cta__content" data-animate>
              ...
              <p>
                導入128社の改善ログを基に、生成AIと専門家が90日で平均ROAS+32%・CVR+26%・指名検索+38%を再現。週次スプリントでLTV1.4倍と回収4.5か月のロードマップをご提示します。
        ...
        >
          <div className="container">
            <div className="section-header" data-animate>
              ...
              <p>
                入力7項目・所要60秒で毎月先着20社の診断枠にお申し込みいただけます。受付後24時間以内に専門家が連絡し、72時間でROI試算と改善ロードマップのドラフトを共有します。
              </p>
            </div>
